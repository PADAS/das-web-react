...
import EditableItem from '../../common/components/forms/EditableItem';
import DasIcon from '../../common/components/icons/DasIcon';
import ReportedBySelect from '../../events/inputs/ReportedBySelect';
import AddEvent from '../../events/forms/AddEvent';
import EventListItem from '../../events/lists/EventListItem';
  ...
  return <EditableItem data={patrolWithFlattenedHistory}>
    <Modal>
      ...
      <AttachmentControls
        ...
        {patrolSegmentId &&<AddEvent map={map}
          analyticsMetadata={{
            category: 'Patrol Modal',
            location: 'patrol modal',
          }}
