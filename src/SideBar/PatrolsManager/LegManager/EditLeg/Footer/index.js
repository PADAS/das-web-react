...
const Footer = ({ disableSaveButton, formId, isSaving, legId, patrolId }) => {
  const { t } = useTranslation('patrols', { keyPrefix: 'editLeg.footer' });

  return <footer className={styles.footer}>
    <Link className={styles.cancelButton} to={`/${TAB_KEYS.PATROLS}/${patrolId}/legs/${legId}`}>
      {t('cancelButton')}
    </Link>
