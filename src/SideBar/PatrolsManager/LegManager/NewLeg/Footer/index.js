...
const Footer = ({ formId, isSaving, patrolId }) => {
  const { t } = useTranslation('patrols', { keyPrefix: 'newLeg.footer' });

  return <footer className={styles.footer}>
    <Link className={styles.cancelButton} to={`/${TAB_KEYS.PATROLS}/${patrolId}`}>{t('cancelButton')}</Link>
