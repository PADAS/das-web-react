    ...
    'ui': {
      'fields': {
        'this_is_a_required_multi-choice_list': {
          ...
          'placeholder': 'This is a hint',
          'type': 'CHOICE_LIST',
          'parent': 'section-23V7YPH6Rw_8VUFGuHUZo'
        },
        'this_is_a_non_required_single-choice_list': {
          'choices': {
            'eventTypeCategories': [],
        ...
        'a_number_field': {
          'placeholder': 'Some example of number',
          'type': 'NUMERIC',
          'parent': 'section-23V7YPH6Rw_8VUFGuHUZo'
        }
      },
...
const schemas = [schemaWithTexts, schemaWithSections, schemaWithDateTimes, headerAndSections, choiceLists, schemaWithNumerics];
