...
import { isStaticTypeSensor } from '../utils/subjects';
...
class Map extends Component {
  ...
  render() {
    ...
    const [staticFeatures, nonStaticFeatures] = partition(mapSubjectFeatureCollection?.features ?? [], subjectFeature => isStaticTypeSensor(subjectFeature));
