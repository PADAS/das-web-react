...
import DelayedUnmount from '../common/components/render/DelayedUnmount';
import EarthRangerMap, { withMap } from './EarthRangerMap';
import EventsLayer from './layers/EventsLayer';
import SubjectsLayer from '../subjects/map/layers/SubjectsLayer';
import TrackLayers from '../tracks/map/layers/TracksLayer';
import PatrolStartStopLayer from './layers/PatrolStartStopLayer';
import FeatureLayer from './layers/FeatureLayer';
import AnalyzerLayer from '../analyzers/AnalyzersLayer';
import PopupLayer from './layers/PopupLayer';
import SubjectHeatLayer from '../subjects/map/layers/SubjectHeatLayer';
import UserCurrentLocationLayer from './layers/UserCurrentLocationLayer';
import SubjectHeatmapLegend from '../subjects/map/legends/SubjectHeatmapLegend';
import SubjectTrackLegend from '../subjects/map/legends/SubjectTrackLegend';
import PatrolTrackLegend from './legends/PatrolTrackLegend';
import EventFilter from '../events/lists/EventFilter';
import TimeSlider from './controls/TimeSlider';
import TimeSliderMapControl from './controls/TimeSlider/TimeSliderMapControl';
import ReportsHeatLayer from '../events/map-layers/EventsHeatLayer';
import ReportsHeatmapLegend from '../events/map/legends/EventsHeatmapLegend';
import MessageBadgeLayer from './layers/MessageBadgeLayer';
// import IsochroneLayer from '../IsochroneLayer';
import MapImagesLayer from './layers/MapImagesLayer';
import ReloadOnProfileChange from '../user/ReloadOnProfileChange';
import SleepDetector from '../browser/SleepDetector';

import MapRulerControl from './controls/MapRulerControl';
import MapPrintControl from './controls/MapPrintControl';
import MapMarkerDropper from './controls/MapMarkerDropper';
import MapBaseLayerControl from './controls/MapBaseLayerControl';
import MapSettingsControl from './controls/MapSettingsControl';
import PatrolTracks from './layers/PatrolTracks';
import CursorGpsDisplay from './controls/CursorGpsDisplay';
import RightClickMarkerDropper from './controls/RightClickMarkerDropper';
