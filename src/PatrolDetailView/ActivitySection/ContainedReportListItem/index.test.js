...
describe('PatrolDetailView - ActivitySection - ContainedReportListItem', () => {
  ...
  test('user can open the report collapsible', async () => {
    ...
    expect((await screen.findByTestId('patrolDetailView-activitySection-collapse-d45cb504-4612-41fe-9ea5-f1b423ac3ba4')))
