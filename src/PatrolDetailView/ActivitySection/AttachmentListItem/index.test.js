...
describe('PatrolDetailView - ActivitySection - AttachmentListItem', () => {
  ...
  test('saved images are collapsibles', async () => {
    ...
    expect((await screen.findAllByTestId((content) => content.startsWith('patrolDetailView-activitySection-collapse'))))
      .toHaveLength(1);
  });
  ...
  test('does not render collapsibles nor fetches images for non saved images', async () => {
    ...
    expect((await screen.queryAllByTestId((content) => content.startsWith('patrolDetailView-activitySection-collapse'))))
      .toHaveLength(0);
  });
  ...
  test('user can open the image collapsible', async () => {
    ...
    expect((await screen.findByTestId('patrolDetailView-activitySection-collapse-1234'))).toHaveClass('collapse');
  ...
  test('user can close the image collapsible', async () => {
    ...
    expect((await screen.findByTestId('patrolDetailView-activitySection-collapse-1234'))).toHaveClass('show');
