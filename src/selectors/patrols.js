...
import { getLeaderForPatrol, extractPatrolPointsFromTrackData, drawLinesBetweenPatrolTrackAndPatrolPoints, patrolShouldBeMeasured } from '../utils/patrols';
...
export const assemblePatrolDataForPatrol = (patrol, leader, trackData, timeSliderState) => {
  ...
  const hasTrackDataWithinPatrolWindow = !!trackData && patrolShouldBeMeasured(patrol) && trackHasDataWithinTimeRange(trackData, timeRange.start_time, timeRange.end_time);
