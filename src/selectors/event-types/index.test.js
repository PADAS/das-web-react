...
import { dogPatrol, routinePatrol } from '../../__test-helpers/fixtures/patrol-types';
import {
  selectCreatableEventTypesByCategory,
  selectDisplayEventTypes,
  selectEventTypeById,
  selectEventTypeByValue,
} from './';

describe('Selectors - Event types', () => {
  const state = {
    data: {
      eventCategories: {
      ...
      patrolTypes: [dogPatrol, routinePatrol],
    },
  };

  describe('selectCreatableEventTypesByCategory', () => {
    test('maps the event types that have creation permission by their category', () => {
      expect(selectCreatableEventTypesByCategory(state)).toEqual([{
        display: 'Monitoring',
        flag: 'user',
  ...
  describe('selectDisplayEventTypes', () => {
    test('joins the event and patrol types into a single array', () => {
      expect(selectDisplayEventTypes(state)).toEqual([{
        auto_resolve: false,
        category: 'security',
        default_priority: 0,
        default_state: 'active',
  ...
  describe('selectEventTypeById', () => {
    test('finds an event type by its id', () => {
      expect(selectEventTypeById(state, '8e2812d8-4ac9-4874-b1b2-1adc5ea192b5')).toEqual({
        auto_resolve: false,
        category: {
          display: 'Security',
          flag: 'user',
  ...
  describe('selectEventTypeByValue', () => {
    test('finds an event type by its value', () => {
      expect(selectEventTypeByValue(state, 'snare_rep')).toEqual({
        auto_resolve: false,
        category: {
          display: 'Security',
          flag: 'user',
