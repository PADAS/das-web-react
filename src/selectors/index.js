...
const hiddenFeatureIDs = ({ data: { mapLayerFilter: { hiddenFeatureIDs } } }) => hiddenFeatureIDs;
const hiddenAnalyzerIDs = ({ data: { mapLayerFilter: { hiddenAnalyzerIDs } } }) => hiddenAnalyzerIDs;
