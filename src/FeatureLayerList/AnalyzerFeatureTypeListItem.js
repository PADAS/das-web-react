...
import AnalyzerFeatureListItem from './FeatureListItem';
...
const AnalyzerFeatureTypeListItem = memo((props) => {
  ...
  return <Collapsible
    ...
    <CheckableList
      ...
      itemComponent={AnalyzerFeatureListItem}
    />
  </Collapsible>
});
...
export default connect(mapStateToProps, { hideFeatures, showFeatures })(AnalyzerFeatureTypeListItem);