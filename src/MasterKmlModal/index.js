...
const DOWNLOAD_URL = `${API_URL}subjects/kml/root`;


const FieldReportModal = ({ id, hideModal }) => {
...
export default connect(null, { hideModal })(FieldReportModal);