...
describe('ReportDetailView - ReportManager', () => {
  let AddReportMock,
      ...
      <Provider store={mockStore(store)}>
        <NavigationWrapper>
          <ReportsTabContext.Provider value={{ loadingEvents: false }}>
            <ReportManager isNewReport newReportTypeId="invalid" reportId="1234" />
  ...
  test('redirects to /reports if user tries to open a report that cannot be found', async () => {
    render(
      <Provider store={mockStore(store)}>
        <NavigationWrapper>
          <ReportsTabContext.Provider value={{ loadingEvents: false }}>
            <ReportManager isNewReport={false} reportId="456" />
          </ReportsTabContext.Provider>
        </NavigationWrapper>
      </Provider>
    );
  ...
  test('does not redirect to /reports if it is an added report', async () => {
    render(
      <Provider store={mockStore(store)}>
        <NavigationWrapper>
          <ReportsTabContext.Provider value={{ loadingEvents: false }}>
            <ReportManager isAddedReport isNewReport newReportTypeId="invalid" reportId="1234" />
          </ReportsTabContext.Provider>
        </NavigationWrapper>
      </Provider>
    );
  ...
  test('updates the title when user types in it', async () => {
    render(
      <Provider store={mockStore(store)}>
        <NavigationWrapper>
          <ReportsTabContext.Provider value={{ loadingEvents: false }}>
            <ReportManager isNewReport newReportTypeId="d0884b8c-4ecb-45da-841d-f2f8d6246abf" reportId="1234" />
          </ReportsTabContext.Provider>
        </NavigationWrapper>
      </Provider>
    );
  ...
  test('triggers onAddReport', async () => {
    ...
    render(
      <Provider store={mockStore(store)}>
        <NavigationWrapper>
          <ReportsTabContext.Provider value={{ loadingEvents: false }}>
            <ReportManager isNewReport={false} onAddReport={onAddReport} reportId="initial" />
          </ReportsTabContext.Provider>
        </NavigationWrapper>
      </Provider>
    );
  ...
  test('if the current report is a collection, adding a new one simply appends it', async () => {
    ...
    render(
      <Provider store={mockStore(store)}>
        <NavigationWrapper>
          <ReportsTabContext.Provider value={{ loadingEvents: false }}>
            <ReportManager isNewReport={false} reportId="initial" />
          </ReportsTabContext.Provider>
        </NavigationWrapper>
      </Provider>
    );
  ...
  test('executes save actions when clicking save and navigates to report feed', async () => {
    render(
      <Provider store={mockStore(store)}>
        <NavigationWrapper>
          <ReportsTabContext.Provider value={{ loadingEvents: false }}>
            <ReportManager isNewReport newReportTypeId="d0884b8c-4ecb-45da-841d-f2f8d6246abf" reportId="456" />
          </ReportsTabContext.Provider>
        </NavigationWrapper>
      </Provider>
    );
