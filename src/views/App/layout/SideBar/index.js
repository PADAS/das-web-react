...
import SubjectGroupList from '../../../../subjects/lists/SubjectGroupList';
import FeatureLayerList from '../../../../featuresets/FeatureLayerList';
import AnalyzerLayerList from '../../../../analyzers/AnalyzerLayerList';
import AddEvent, { STORAGE_KEY as ADD_BUTTON_STORAGE_KEY } from '../../../../events/forms/AddEvent';
import PatrolFilter from '../../../../patrols/PatrolFilter';

import { trackEvent } from '../../../../utils/analytics';
import undoable, { calcInitialUndoableState, undo } from '../../../../reducers/undoable';

import ReportsTab from './ReportsTab';
import ClearAllControl from '../../../../map/controls/ClearAllControl';
import ReportMapControl from '../../../../map/controls/ReportMapControl';
import ErrorBoundary from '../../../../common/components/errors/ErrorBoundary';
import PatrolList from '../../../../patrols/PatrolList';
import MapLayerFilter from '../../../../map/lists/MapLayerFilter';
    ...
    <MapContext.Provider value={map}>
      <aside className={`${'side-menu'} ${sidebarOpen ? styles.sidebarOpen : ''}`}>
        ...
        {activeTab.current !== TAB_KEYS.LAYERS && <div className={styles.addReportContainer}>
          <AddEvent popoverPlacement={addReportPopoverPlacement} map={map} showLabel={false} type={activeTab.current} />
        </div>}
