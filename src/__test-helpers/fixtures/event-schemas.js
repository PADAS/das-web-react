...
export const snareSchemaV1 = {
  schema: {
    $schema: 'http://json-schema.org/draft-04/schema#',
    title: 'Snare Report (snare_rep)',
    type: 'object',
    properties: {
      snarerep_numberofsnares: {
        type: 'number',
        title: 'Number of Snares Found',
      },
    },
    id: 'https://root.dev.pamdas.org/api/v1.0/activity/events/schema/eventtype/snare_rep',
    icon_id: 'snare_rep',
    image_url: 'https://root.dev.pamdas.org/static/snare-black.svg',
  },
  definition: [
    {
      key: 'snarerep_numberofsnares',
      htmlClass: 'col-lg-6',
    },
  ],
};
