...
## Setting up
To start developing this repo, you need to have [Docker](https://www.docker.com/get-started) installed. Once docker is up and running, `cd` into the root of this project repository and run the following command: `docker-compose up --build`.
