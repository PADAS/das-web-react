FROM europe-west3-docker.pkg.dev/serca-artifact-registry/docker-mirror/library/node:22-alpine AS build
...
FROM europe-west3-docker.pkg.dev/serca-artifact-registry/docker-mirror/library/nginx:1.29-alpine
